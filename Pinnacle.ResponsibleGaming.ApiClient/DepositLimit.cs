...
namespace Pinnacle.ResponsibleGaming.ApiClient
{
    ...
    public partial class DepositLimit : IServiceOperations<ResponsibleGamingApi>, IDepositLimit
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> GetWithHttpMessagesAsync(string customerId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (customerId == null)
            {
